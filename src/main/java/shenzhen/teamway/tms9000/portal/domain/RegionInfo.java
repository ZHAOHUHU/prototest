...
public class RegionInfo implements Serializable {
	...
	public String toString() {
		return "RegionInfo [id=" + id + ", pId=" + pId + ", typeId=" + typeId + ", icon=" + icon + ", name=" + name
				+ ", state=" + state + ", code=" + code + ", createTime=" + createTime + ", updateTime=" + updateTime
				+ ", remark=" + remark + ", creater=" + creater + ", lastUpdateBy=" + lastUpdateBy + "]";
	}
